...
When `requireState = true`, users must configure a `state` handler for the resource, typically referencing a state storage resource. NixOps will validate this requirement at evaluation time.
