                ...
                (async move {
                    ...
                    match outcome {
                        Outcome::ResourceOutputs(outputs) => {
                            if let Some(_value) =
                                outputs.output_properties.unwrap_or_default().get(&property)
                            {
            ...
            Goal::ApplyResource(id, name) => {
                ...
                (async move {
                    ...
                    let resource = v0::ExtantResource {
                        ...
                        output_properties: Some(outputs),
                        type_: provider_info.resource_type,
                    };
            ...
            Goal::Apply() => {
                (async {
                    ...
                    for (resource_name, resource_id) in resource_ids.iter() {
                        ...
                        let outputs = resource_map
                            .get(resource_id)
                            .map_or(&empty, |v| v.output_properties.as_ref().unwrap_or(&empty));
