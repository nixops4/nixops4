          ...
          }:
          {
            ...
            members.nestedDeployment =
              { members, ... }:
              {
                ...
                # Uses outer `members` from closure to reference parent-level siblings
                members.frontend = {
                ...
                members.deploymentSummary = {
                  ...
                  inputs.initialize_with = lib.concatStringsSep "|" [
                    ...
                    "static:${members.frontend.members.staticVersion.outputs.value}"
            ...
            members.structuralCycle =
              { members, ... }:
              {
                ...
                // lib.optionalAttrs (members.selector.outputs.value == "enabled") {
